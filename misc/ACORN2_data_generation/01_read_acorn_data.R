...
print("Start to read data dictionary") # [UPDATED ACORN2]
...
print("Data dictionary read") # [UPDATED ACORN2]
...
if (input$format_lab_data == "WHONET .dBase")  amr.loc <- foreign::read.dbf(path_lab_file, as.is = TRUE) # [UPDATED ACORN2]
