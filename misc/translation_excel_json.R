...
# JSON to Excel files ----
# json_file = RJSONIO::fromJSON("./misc/translation_excel.json")
# 
...
# trans_df |> 
#   select(en, kh) |> 
#   writexl::write_xlsx(path = "/Users/olivier/Documents/Projets/ACORN/acorn-dashboard/misc/en_kh.xlsx")
# 
# trans_df |> 
#   select(en, vn) |> 
...
en_kh <- read_excel(path = "/Users/olivier/Documents/Projets/ACORN/acorn-dashboard/misc/en_kh.xlsx")
...
list(languages = c("en", "fr", "la", "kh", "vn", "ba"),
  ...
  write(file = "./misc/translation.json")
