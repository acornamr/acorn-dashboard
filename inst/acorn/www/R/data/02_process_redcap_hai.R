...
ifelse(nrow(test) == 0, 
       ...
       { checklist_status$redcap_hai_status <- list(status = "warning", msg = i18n$t("Some dates of enrolment for HAI patients don't have a matching date in the HAI survey dataset"))
