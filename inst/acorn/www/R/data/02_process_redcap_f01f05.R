...
infection <- infection %>% transmute(
  ...
  bsi_antibiotic6_name, bsi_antibiotic6_name_oth, bsi_antibiotic6_startdate, 
  bsi_antibiotic6_enddate, bsi_antibiotic6_route,
  bsi_antibiotic7_name, bsi_antibiotic7_name_oth, bsi_antibiotic7_startdate, 
  bsi_antibiotic7_enddate, bsi_antibiotic7_route,
  bsi_antibiotic8_name, bsi_antibiotic8_name_oth, bsi_antibiotic8_startdate, 
  bsi_antibiotic8_enddate, bsi_antibiotic8_route,
  bsi_antibiotic9_name, bsi_antibiotic9_name_oth, bsi_antibiotic9_startdate, 
  bsi_antibiotic9_enddate, bsi_antibiotic9_route,
  bsi_antibiotic10_name, bsi_antibiotic10_name_oth, bsi_antibiotic10_startdate, 
  bsi_antibiotic10_enddate, bsi_antibiotic10_route,
