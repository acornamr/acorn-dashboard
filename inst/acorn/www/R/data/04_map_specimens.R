message("Source 03_map_specimens.R")
...
local.spec <- subset(local.spec, select = c(acorn.spec.code, local.spec.code1:ncol(local.spec))) # This code allows for columns to be added to the spreadsheet (for further spectypes)
